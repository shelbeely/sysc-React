...
Want to capture animations as GIFs for your README? See [examples/RECORDING.md](./examples/RECORDING.md) for comprehensive guide on recording terminal animations using:
